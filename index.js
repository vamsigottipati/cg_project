...
bird2 = new Bird();
bird2.threegroup.position.x = -300;
bird2.side = "right";
...
bird3 = new Bird();
bird3.threegroup.position.x = 300;
bird3.side = "left";
...
bird1.bodyBird.material.color.setRGB(.20 , .20 , .20);
bird1.threegroup.scale.set(1.5, 1.2, 1.2)
...
// bird2.bodyBird.material.color.setRGB(0.9 , 0.1 , 0.1);
